...
function (_Component) {
  ...
  function DeleteItem() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      console.log("payload: ", payload); // 2. Filter the deleted items out of the page

      data.items = data.items.filter(function (item) {
        return data.id !== payload.data.deleteItem.id;
...
//# sourceMappingURL=items.js.4754bda7f6e52e0a7453.hot-update.js.map