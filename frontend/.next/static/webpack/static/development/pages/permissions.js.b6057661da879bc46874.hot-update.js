...
function permissions() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_User__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    var permissions = _ref.data.me.permissions;
    console.log("User data: ", permissions);
    var map = permissions.map(function (admin) {
      return ["ADMIN"].includes(admin);
    });
    var admin = permissions.filter(map);
    console.log(admin);
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, admin ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Permissions__WEBPACK_IMPORTED_MODULE_2__["default"], {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 18
      },
...
//# sourceMappingURL=permissions.js.b6057661da879bc46874.hot-update.js.map